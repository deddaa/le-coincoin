...
function Annonce() {
  ...
  return (
    <>
    <Link className="font-bold hover:text-purple-500 hover:underline transition-all m-10" to="/">Retour à l'accueil</Link>
    <div className="max-w-3xl mx-auto px-4 py-8 border border-gray-300 shadow-2xl rounded-2xl m-10">
      ...
      <p className="text-purple-600 font-bold text-xl mt-2">{annonce.price} €</p>
